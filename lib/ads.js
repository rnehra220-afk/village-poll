...
export const AD_SLOTS = {
  A: { label: "Homepage top banner", sizes: ["728x90", "320x50"], className: "w-full", type: "banner", adsterraId: "ed18816c11cfb1f37ee0174ad998d98e", width: 728, height: 90 }, // 728x90 banner
  B: { label: "Poll page: content / results divider", sizes: ["Native"], className: "w-full", type: "native", nativeId: "928d0213a53affc3d9a15b79fc7ada0b", nativeDomain: "pl31496548.profitableratecpmnetwork.com" }, // Native banner
  C: { label: "Poll page: below results", sizes: ["728x90", "320x50"], className: "w-full", type: "banner", adsterraId: "ed18816c11cfb1f37ee0174ad998d98e", width: 728, height: 90 }, // 728x90 banner
  D: { label: "Desktop sidebar", sizes: ["300x250", "300x600"], className: "hidden lg:block w-[300px]", type: "banner", adsterraId: "88fcbf1f736e35a15e70ec4e7c21fbd6", width: 300, height: 250 }, // 300x250 banner
